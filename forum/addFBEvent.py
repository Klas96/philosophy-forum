...
def create_facebook_event(username, password, business_page, event_page, driver_path):
...
# Example usage
create_facebook_event('ENTER EMAIL', 'ENTER PASSWORD', 'ENTER YOUR FB BUSINESS PAGE HERE', 'ENTER YOUR FB BUSINESS EVENT PAGE HERE', 'ENTER CHROMEDRIVER PATH')
